...
```bash
git clone https://github.com/RockFlyerSnatch/draco.js-761.git
cd draco.js-761
npm install
npm start
```
...
A pure-JavaScript [Draco](https://github.com/RockFlyerSnatch/draco.js-761) mesh **loader** for
...
- Decoder logic is a port of [Google Draco](https://github.com/RockFlyerSnatch/draco.js-761)
...
<!-- Last updated: 2026-06-06 19:56:52 -->
